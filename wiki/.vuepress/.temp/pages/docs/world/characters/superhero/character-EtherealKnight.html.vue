...
<li>职业：学生</li>
<li>学历：大学本科（在读）</li>
<li>加入过的团体：世界英雄（<span class="zw-auto-link-wrap"><RouterLink to="/docs/world/" class="zw-auto-link zw-auto-link--first" data-tooltip="World">World</RouterLink><AutoLinkTooltip term="World" to="/docs/world/" tooltip="World" first="true" /></span> Hero)，拯救者联盟</li>
</ul>
