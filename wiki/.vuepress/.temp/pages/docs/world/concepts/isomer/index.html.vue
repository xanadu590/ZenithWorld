<template><div><p>名称：<RouteLink to="/docs/world/concepts/isomer/">异常构造</RouteLink><br>
译名：Isomer<br>
简称：异构、ISO</p>
<h2 id="关于「异常构造」的详细定义" tabindex="-1"><a class="header-anchor" href="#关于「异常构造」的详细定义"><span>关于「异常构造」的详细定义</span></a></h2>
<p>在这个世界，即便存在大量离奇事物，【<RouteLink to="/docs/world/concepts/isomer/">异常构造</RouteLink>】仍是其中最特殊且最危险的一类。</p>
...
<p>某位博士提出了一个颠覆性的理论：【<RouteLink to="/docs/world/concepts/isomer/">异常构造</RouteLink>】的本质，是对【宇宙本源】的消耗行为。<br>
